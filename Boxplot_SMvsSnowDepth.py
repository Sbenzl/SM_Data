# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 12:38:08 2023
...
df = pd.read_csv(r"C:\Users\skyebensel\.spyder-py3\Field_Hydrology/SM_Data.csv", usecols=column_subset)
...
plt.title('Boxplot of Soil Moisture vs Snow Depth')
